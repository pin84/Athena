...
export default {
  ...
  methods: {
    _start() {
      ...
      const setSelectFruit = id => {
        selectFruit = id;
        render();
      };

      const render = () => {
        this.fruitsBowl(svg, { fruits, height, setSelectFruit, selectFruit });
      };
    ...
    fruitsBowl(selection, props) {
      ...
      const { fruits, height, setSelectFruit, selectFruit } = props;
      ...
      circle
        ...
        .on("mouseover", d => setSelectFruit(d.id))
        .on("mouseout", () => setSelectFruit(null))
        .transition()
        .duration(1000)
        .attr("cx", xPosition)
